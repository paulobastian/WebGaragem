...
namespace WebGaragem.Controllers
{
    ...
    public class ModeloesController : BaseController
    {
        ...
        {
            var temAcesso = await Usuario_Tem_Acesso(7, _context);
        ...
        public async Task<IActionResult> Create([Bind("ID,NomeModelo")] Modelo modelo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,NomeModelo")] Modelo modelo)
        {
            if (id != modelo.ID)
            {
                return NotFound();
