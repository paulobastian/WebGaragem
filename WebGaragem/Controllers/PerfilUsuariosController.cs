...
namespace WebGaragem.Controllers
{
    ...
    public class PerfilUsuariosController : BaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var webGaragemContext = _context.PerfilUsuario.Include(p => p.IdentityUser).Include(p => p.TipoUsuario);
        ...
        {
            ViewData["UserId"] = new SelectList(_context.Set<IdentityUser>(), "Id", "Email");
        ...
        public async Task<IActionResult> Create([Bind("Id,IdTipoUsuario,UserId")] PerfilUsuario perfilUsuario)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Set<IdentityUser>(), "Id", "Email", perfilUsuario.UserId);
