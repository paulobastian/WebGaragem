...
namespace WebGaragem.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NomeMarca = table.Column<string>(maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NomeModelo = table.Column<string>(maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnoVeiculo = table.Column<DateTime>(nullable: true),
                    ...
                    TipoCombustivel = table.Column<string>(maxLength: 250, nullable: true),
                    DataVenda = table.Column<DateTime>(nullable: true),

                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Anuncio", x => new { x.Id });

                    table.ForeignKey(
                        name: "FK_Anuncio_Marca_IdMarca",
                        column: x => x.IdMarca,
                    ...
                    table.ForeignKey(
                        name: "FK_Anuncio_Modelo_IdModelo",
                        column: x => x.IdModelo,
